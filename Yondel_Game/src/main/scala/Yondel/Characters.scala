...
class Characters {
  ...
  class Characters(var name: String, var job: String) {
    private var Char_name: String = this.name
    private var Char_job: String = this.job
    private var Level: Int = 0
    private var Inventory = new Array[String](5)
    private var Weapon: String = new String
